...
OFF_SWITCHES = ("production_enabled", "network_enabled", "real_sources_enabled", "source_writes_enabled", "external_notifications_enabled")
...
def validate() -> None:
    ...
    for name in ("run-record.v1.schema.json", "snapshot.v1.schema.json", "alert.v1.schema.json", "schedule-decision.v1.schema.json"):
...
if __name__ == "__main__":
    validate()
    print("Project Brain v2 M2 runtime contracts passed: default_disabled=true production_capabilities=false network_imports=0 schemas=5")
