...
| SP-H034 | CA-SC 自建俱乐部 | 首个会员侧列表/详情/加入/本人状态闭环派发 | 平台集成负责人 | 俱乐部联盟自建俱乐部负责人 | 2026-07-12 | 平台派发已集成，P0/P1 合同工作项 active | standard+general；合同先行，后端/前端独立；创建/审核/资金禁止 |
...
- 当前状态：平台派发已集成至 `893f7856530e2396d66c877b97198bf3d365e3b0`；模块合同工作项已从同一干净基线激活；后端、前端工作项保持 planned，等待 Contract Go。
