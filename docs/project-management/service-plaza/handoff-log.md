...
| SP-H034 | CA-SC 自建俱乐部 | 首个会员侧列表/详情/加入/本人状态闭环派发 | 平台集成负责人 | 俱乐部联盟自建俱乐部负责人 | 2026-07-12 | 平台派发治理进行中，模块待激活 | standard+general；合同先行，后端/前端独立；创建/审核/资金禁止 |
...
- 当前状态：平台派发工作项 active；模块、后端、前端工作项 planned，必须等待各自上游 Go。
